...
const Footer = () => {
  return (
    <footer className="bg-[#130a06] text-[#facc15] text-white py-16">
...
<div className="lg:col-span-1">
  <div className="flex items-center space-x-4 mb-4">
    ...
    <span className="text-yellow-500 font-bold text-xl">TERRANOX Estates</span>
  </div>
      ...
      <a href="https://www.linkedin.com/in/terranox-estate-668671371?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app">
        <Linkedin className="w-5 h-5 text-gray-400 hover:text-orange-400 cursor-pointer transition-colors" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">M3M The Cullinan</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">M3M The Line</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Trump Towers 1.0</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Trump Tower Noida</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">JACOB AND CO. Residences</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Godrej Riverine             </a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Elie Saab Residencies</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/about-company" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Our Mission & Vision</a></li>

              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Builders</a></li>
           
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">News And Media</a></li>
              <li><a href="/career" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Careers</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">FAQs</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Noida</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Faridabad</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">New Delhi</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors text-sm">Gurgaon</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">Copyright Policy</a>
            <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors text-sm">Terms & Conditions</a>
          </div>
        </div>
      </div>
    </footer>
